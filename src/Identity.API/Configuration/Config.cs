    ...
    public class Config
    {
        ...
        public static IEnumerable<ApiResource> GetApis()
        {
            return new List<ApiResource>
            {
                ...
                new ApiResource("catalog", "Catalog Service") // new by Boiz
                {
                    UserClaims = { "role" }, // call Identity đưa claim "role" vào token cho audience catalog
                },
            };
        }
        ...
        public static IEnumerable<ApiScope> GetApiScopes()
        {
            return new List<ApiScope>
            {
                ...
                new ApiScope("catalog", "Catalog Service"), // new by Boiz
            };
        }
        ...
        public static IEnumerable<Client> GetClients(IConfiguration configuration)
        {
            return new List<Client>
            {
                new Client
                {
                    ...
                    {
                        $"{configuration["MauiCallback"]}/Account/Redirecting",
                    },
                ...
                new Client
                {
                    ...
                    RedirectUris =
                    {
                        $"{configuration["BasketApiClient"]}/swagger/oauth2-redirect.html",
                    },
                ...
                new Client
                {
                    ...
                    RedirectUris =
                    {
                        $"{configuration["WebhooksApiClient"]}/swagger/oauth2-redirect.html",
                    },
                ...
                new Client
                {
                    ClientId = "catalogtest",
                    ClientName = "Catalog Test Client (ROPC)",
